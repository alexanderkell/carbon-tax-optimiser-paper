...
% 	0 \leq a_2\leq 250
% \end{equation*}
 \noindent where $p_c$ is the carbon price, $y_t$ is the year, $a_1$ is the gradient or first attribute and $a_2$ is the intercept or second attribute. $a_1$ was bound by $-14$ and $14$, and $a_2$ by 0 and 250. These bounds were chosen to ensure that the carbon price did not exceed ${\sim}$\textsterling500 in the year 18 (2035) and was greater than about -\textsterling250, as well as ensuring that the carbon tax in the first year was greater than \textsterling0 but smaller than \textsterling250.
