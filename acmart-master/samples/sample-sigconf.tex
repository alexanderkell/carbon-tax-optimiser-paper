...
In this paper we demonstrate how to to find optimal carbon tax policies by using a genetic algorithm approach to model the electricity market agent-based model ElecSim. To achieve this we use the NSGA-II genetic algorithm to minimise average electricity price and relative carbon intensity of the electricity mix. We demonstrate that it is possible find a range of carbon taxes to suit different objectives. We minimise electricity cost to below \textsterling10/MWh and reduce carbon intensity to 0 in all cases. The optimal carbon tax strategies generally increase from 2020 to 2035, and are above \textsterling81/tCO2 in all instances, with a mean of \textsterling240/tCO2.
